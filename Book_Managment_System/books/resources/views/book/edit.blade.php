            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        @error('title') is-invalid @enderror" value="{{old('title',$book->title)}}">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        @error('author') is-invalid @enderror" value="{{old('title',$book->author)}}">
                        @error('author')
                        <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="publication" id="publication" placeholder="Enter publication" class="form-control" value="{{old('title',$book->publication)}}">

                    </div>
                </div>
            </div>
            <button class="btn btn-primary my-3">Update Book</button>
        </form>
    </div>
</body>
</html>